...
<body>
    ...
    <div id="nav">
     ...
     <div>
        <h2 id="registered">Registered Successfully</h2>
    </div>
    ...
    if(error!=null){
    %>
    <h3 style=" position:relative; left:400px; top:300px;color:yellow"> <%=session.getAttribute("error") %></h3>
    <%} %>
    <!--Regster-->
    <div id="register">
        <b>Register Form</b>
        <form action = "add" onsubmit="return  reg()">
            ...
            <br>
            <input type="password" name="pass" id="rpass" pattern="^(?=.[0-9])(?=.[a-z])(?=.[A-Z])(?=.[!@#&?/*$^]).{5,12}$" title="Minimum 5 characters should be there.Special characters allowed"
